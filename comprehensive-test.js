...
const EXTENSIVE_TEST_CASES = {
    ...
    fullWordVariations: [
        ...
        { input: 'Inject 10 units subcutaneously before meals', expected: { quantity: '10', unit: 'unit', route: 'subcutaneous', frequency: 'meal_relative' } },
        { input: 'Apply cream topically twice daily', expected: { quantity: null, unit: null, route: 'topical', frequency: 'twice_daily' } },
        { input: 'Instill 2 drops in each eye every 4 hours', expected: { quantity: '2', unit: 'drop', route: 'ophthalmic', frequency: 'every_n_hours' } },
        { input: 'Place 1 patch on skin every 72 hours', expected: { quantity: '1', unit: 'patch', route: 'topical', frequency: null } },
        { input: 'Use 1 spray in each nostril twice daily', expected: { quantity: '1', unit: 'spray', route: 'nasal', frequency: 'twice_daily' } },
        { input: 'Take 1 puff from inhaler every 6 hours', expected: { quantity: '1', unit: 'puff', route: 'inhalation', frequency: 'every_n_hours' } },
        { input: 'Insert 1 suppository rectally at bedtime', expected: { quantity: '1', unit: 'supp', route: 'rectal', frequency: 'at_bedtime' } },
    ],
