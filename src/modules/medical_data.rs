...
// ============================================================================
// LEGACY NORMALIZATION MAPPINGS (for backward compatibility)
// ============================================================================
...
/// Dosage limits: (unit, min, max, typical_dose)
...
pub static MEDICATIONS: Lazy<HashMap<&'static str, Medication>> = Lazy::new(|| {
    ...
    // A
    meds.insert("acetaminophen", Medication {
    ...
    meds.insert("acyclovir", Medication {
    ...
    meds.insert("albuterol", Medication {
    ...
    meds.insert("allopurinol", Medication {
    ...
    meds.insert("amlodipine", Medication {
    ...
    meds.insert("amoxicillin", Medication {
    ...
    meds.insert("aripiprazole", Medication {
    ...
    meds.insert("aspirin", Medication {
    ...
    meds.insert("atorvastatin", Medication {
    ...
    meds.insert("azithromycin", Medication {
    ...
    // B
    meds.insert("baclofen", Medication {
    ...
    meds.insert("bisacodyl", Medication {
    ...
    // C
    meds.insert("carvedilol", Medication {
    ...
    meds.insert("cephalexin", Medication {
    ...
    meds.insert("ciprofloxacin", Medication {
    ...
    meds.insert("clonazepam", Medication {
    ...
    meds.insert("clopidogrel", Medication {
    ...
    // D
    meds.insert("diazepam", Medication {
    ...
    meds.insert("digoxin", Medication {
    ...
    meds.insert("diltiazem", Medication {
    ...
    // E
    meds.insert("enalapril", Medication {
    ...
    meds.insert("escitalopram", Medication {
    ...
    // F
    meds.insert("furosemide", Medication {
    ...
    // G
    meds.insert("gabapentin", Medication {
    ...
    meds.insert("glipizide", Medication {
    ...
    // H
    meds.insert("heparin", Medication {
    ...
    meds.insert("hydrochlorothiazide", Medication {
    ...
    meds.insert("hydrocodone", Medication {
    ...
    // I
    meds.insert("ibuprofen", Medication {
    ...
    meds.insert("insulin", Medication {
    ...
    // L
    meds.insert("levothyroxine", Medication {
    ...
    meds.insert("lisinopril", Medication {
    ...
    meds.insert("lorazepam", Medication {
    ...
    meds.insert("losartan", Medication {
    ...
    // M
    meds.insert("meloxicam", Medication {
    ...
    meds.insert("metformin", Medication {
    ...
    meds.insert("methylprednisolone", Medication {
    ...
    meds.insert("metoprolol", Medication {
    ...
    meds.insert("morphine", Medication {
    ...
    // N
    meds.insert("naproxen", Medication {
    ...
    // O
    meds.insert("omeprazole", Medication {
    ...
    meds.insert("ondansetron", Medication {
    ...
    meds.insert("oxycodone", Medication {
    ...
    // P
    meds.insert("pantoprazole", Medication {
    ...
    meds.insert("prednisone", Medication {
    ...
    // Q
    meds.insert("quetiapine", Medication {
    ...
    // R
    meds.insert("ranitidine", Medication {
        generic_name: "ranitidine",
        brand_names: &["zantac"],
        typical_dose_range: (75.0, 300.0),
        common_unit: "mg",
        category: MedicationCategory::Gastrointestinal,
        requires_special_instructions: false,
    });
    ...
    // S
    meds.insert("sertraline", Medication {
    ...
    meds.insert("simvastatin", Medication {
    ...
    meds.insert("spironolactone", Medication {
    ...
    // T
    meds.insert("tamsulosin", Medication {
    ...
    meds.insert("tramadol", Medication {
    ...
    meds.insert("trazodone", Medication {
    ...
    // V
    meds.insert("valsartan", Medication {
    ...
    meds.insert("venlafaxine", Medication {
    ...
    // W
    meds.insert("warfarin", Medication {
...
pub static ROUTES: Lazy<HashMap<&'static str, Route>> = Lazy::new(|| {
    ...
    routes.insert("intravenous", Route {
    ...
    routes.insert("intramuscular", Route {
    ...
    routes.insert("subcutaneous", Route {
    ...
    routes.insert("sublingual", Route {
    ...
    routes.insert("inhalation", Route {
        canonical: "inhalation",
        abbreviations: &["inh", "inhaled", "inhale", "nebulized", "nebulizer", "inhaler"],
        description: "Into the lungs",
        snomed_ct_code: Some("447694001"),
        requires_site_specification: false,
    });

    routes.insert("ophthalmic", Route {
    ...
    routes.insert("enteral", Route {
        canonical: "enteral",
        abbreviations: &["ng", "ngt", "nasogastric", "g-tube", "gtube", "gastrostomy", "j-tube", "jtube", "jejunostomy"],
        description: "Via feeding tube",
        snomed_ct_code: None,
        requires_site_specification: true,
    });

    routes.insert("intradermal", Route {
...
pub static UNITS: Lazy<HashMap<&'static str, Unit>> = Lazy::new(|| {
    ...
    units.insert("unit", Unit {
        canonical: "unit",
        aliases: &["units", "u", "iu", "international unit", "international units"],
...
pub static FREQUENCIES: Lazy<HashMap<&'static str, Frequency>> = Lazy::new(|| {
    ...
    freqs.insert("once_daily", Frequency {
        canonical: "once_daily",
        abbreviations: &["qd", "q.d.", "daily", "qday", "every day", "each day"],
        description: "Once per day",
        times_per_day: 1.0,
        fhir_timing: Some("{\"repeat\": {\"frequency\": 1, \"period\": 1, \"periodUnit\": \"d\"}}"),
    });

    freqs.insert("twice_daily", Frequency {
        canonical: "twice_daily",
        abbreviations: &["bid", "b.i.d.", "twice daily", "2x daily", "two times daily"],
        description: "Twice per day",
        times_per_day: 2.0,
        fhir_timing: Some("{\"repeat\": {\"frequency\": 2, \"period\": 1, \"periodUnit\": \"d\"}}"),
    });

    freqs.insert("three_times_daily", Frequency {
        canonical: "three_times_daily",
        abbreviations: &["tid", "t.i.d.", "three times daily", "3x daily"],
        description: "Three times per day",
        times_per_day: 3.0,
        fhir_timing: Some("{\"repeat\": {\"frequency\": 3, \"period\": 1, \"periodUnit\": \"d\"}}"),
    });

    freqs.insert("four_times_daily", Frequency {
        canonical: "four_times_daily",
        abbreviations: &["qid", "q.i.d.", "four times daily", "4x daily"],
        description: "Four times per day",
        times_per_day: 4.0,
        fhir_timing: Some("{\"repeat\": {\"frequency\": 4, \"period\": 1, \"periodUnit\": \"d\"}}"),
    });

    freqs.insert("every_4_hours", Frequency {
        canonical: "every_4_hours",
        abbreviations: &["q4h", "q4hr", "q4hours", "every 4 hours", "every 4 hrs", "every four hours"],
        description: "Every 4 hours",
        times_per_day: 6.0,
        fhir_timing: Some("{\"repeat\": {\"frequency\": 1, \"period\": 4, \"periodUnit\": \"h\"}}"),
    });

    freqs.insert("every_6_hours", Frequency {
        canonical: "every_6_hours",
        abbreviations: &["q6h", "q6hr", "q6hours", "every 6 hours", "every 6 hrs", "every six hours"],
        description: "Every 6 hours",
        times_per_day: 4.0,
        fhir_timing: Some("{\"repeat\": {\"frequency\": 1, \"period\": 6, \"periodUnit\": \"h\"}}"),
    });

    freqs.insert("every_8_hours", Frequency {
        canonical: "every_8_hours",
        abbreviations: &["q8h", "q8hr", "q8hours", "every 8 hours", "every 8 hrs", "every eight hours"],
        description: "Every 8 hours",
        times_per_day: 3.0,
        fhir_timing: Some("{\"repeat\": {\"frequency\": 1, \"period\": 8, \"periodUnit\": \"h\"}}"),
    });

    freqs.insert("every_12_hours", Frequency {
        canonical: "every_12_hours",
        abbreviations: &["q12h", "q12hr", "q12hours", "every 12 hours", "every 12 hrs", "every twelve hours"],
        description: "Every 12 hours",
        times_per_day: 2.0,
        fhir_timing: Some("{\"repeat\": {\"frequency\": 1, \"period\": 12, \"periodUnit\": \"h\"}}"),
    });

    freqs.insert("every_24_hours", Frequency {
        canonical: "every_24_hours",
        abbreviations: &["q24h", "q24hr", "q24hours", "every 24 hours", "every 24 hrs"],
        description: "Every 24 hours",
        times_per_day: 1.0,
        fhir_timing: Some("{\"repeat\": {\"frequency\": 1, \"period\": 24, \"periodUnit\": \"h\"}}"),
    });

    freqs.insert("every_72_hours", Frequency {
        canonical: "every_72_hours",
        abbreviations: &["q72h", "q72hr", "every 72 hours", "every 72 hrs", "every three days"],
        description: "Every 72 hours",
        times_per_day: 0.33,
        fhir_timing: None,
    });

    freqs.insert("as_needed", Frequency {
        canonical: "as_needed",
    ...
    freqs.insert("at_bedtime", Frequency {
    ...
    freqs.insert("morning", Frequency {
        canonical: "morning",
        abbreviations: &["am", "a.m.", "morning", "qam", "q.a.m.", "every morning", "in the morning"],
        description: "In the morning",
        times_per_day: 1.0,
        fhir_timing: Some("{\"repeat\": {\"when\": [\"MORN\"]}}"),
    });

    freqs.insert("evening", Frequency {
        canonical: "evening",
        abbreviations: &["pm", "p.m.", "evening", "qpm", "q.p.m.", "every evening", "in the evening"],
        description: "In the evening",
        times_per_day: 1.0,
        fhir_timing: Some("{\"repeat\": {\"when\": [\"EVE\"]}}"),
    });

    freqs.insert("every_other_day", Frequency {
    ...
    freqs.insert("once_weekly", Frequency {
        canonical: "once_weekly",
        abbreviations: &["weekly", "qwk", "once weekly", "every week"],
        description: "Once per week",
        times_per_day: 0.14,
        fhir_timing: Some("{\"repeat\": {\"frequency\": 1, \"period\": 1, \"periodUnit\": \"wk\"}}"),
    });

    freqs.insert("twice_weekly", Frequency {
    ...
    freqs.insert("every_two_weeks", Frequency {
    ...
    freqs.insert("monthly", Frequency {
        canonical: "monthly",
        abbreviations: &["qmo", "once monthly", "every month", "qmonth"],
        description: "Once per month",
        times_per_day: 0.03,
        fhir_timing: Some("{\"repeat\": {\"frequency\": 1, \"period\": 1, \"periodUnit\": \"mo\"}}"),
    });

    freqs.insert("before_meals", Frequency {
    ...
    freqs.insert("after_meals", Frequency {
    ...
    freqs.insert("with_meals", Frequency {
    ...
    freqs.insert("once", Frequency {
        canonical: "once",
        abbreviations: &["stat", "statim", "immediately", "now", "one time", "single dose", "one dose"],
        description: "One time only",
        times_per_day: 1.0,
        fhir_timing: Some("{\"repeat\": {\"frequency\": 1, \"period\": 0, \"periodUnit\": \"d\"}}"),
    });
...
pub static INDICATIONS: &[&'static str] = &[
    "pain", "fever", "inflammation", "infection", "bacteria", "virus",
    "hypertension", "high blood pressure", "bp", "heart",
    "diabetes", "blood sugar", "glucose",
    "cholesterol", "lipids",
    "anxiety", "depression", "mood", "sleep", "insomnia",
    "seizure", "epilepsy", "convulsion",
    "nausea", "vomiting", "upset stomach", "gerd", "reflux", "heartburn",
    "constipation", "diarrhea",
    "asthma", "copd", "breathing", "wheezing",
    "allergies", "allergic", "reaction",
    "blood clot", "clotting", "inr",
    "thyroid",
    "gout",
    "migraine", "headache",
...
pub static SPECIAL_INSTRUCTIONS: Lazy<HashMap<&'static str, SpecialInstruction>> = Lazy::new(|| {
    let mut instrs = HashMap::new();

    instrs.insert("with_food", SpecialInstruction {
        keyword: "with food",
        instruction: "Take with food to reduce stomach upset",
        priority: InstructionPriority::Important,
    });

    instrs.insert("with_meals", SpecialInstruction {
        keyword: "with meals",
        instruction: "Take with meals",
        priority: InstructionPriority::Important,
    });

    instrs.insert("empty_stomach", SpecialInstruction {
...
pub fn validate_medication_order(
            ...
            if unit_str == med.common_unit {
                if quantity < med.typical_dose_range.0 || quantity > med.typical_dose_range.1 {
                    report.warnings.push(format!(
                        ...
                        med.generic_name, quantity, unit_str,
                        med.typical_dose_range.0, med.typical_dose_range.1, med.common_unit
                    ));
                }
            }
    ...
    // Validate quantity
    if quantity <= 0.0 {
        report.errors.push("Quantity must be greater than zero".to_string());
        report.is_valid = false;
    }

    if quantity > 10000.0 {
        report.warnings.push("Quantity is unusually large".to_string());
    }
    ...
    if let Some(f) = frequency {
        if lookup_frequency(f).is_none() {
            report.warnings.push(format!("Unrecognized frequency: {}", f));
        }
    }
